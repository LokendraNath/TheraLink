            ...
            <div className="space-y-4">
              ...
              <div>
                <h1 className="text-4xl font-bold mb-2">
                  Unlock Premium AI Mental Care
                </h1>
                <p className="text-muted-foreground">
                  Get unlimited AI consultations, advanced features, and
                  priority support to take your mental health to the next level.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-8">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Select the perfect plan for your mental care needs. All plans
