      ...
      <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30">
        ...
        <CardContent className="relative p-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Get instant mental advice through voice calls
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-primary rounded-full"></div>
              <span className="text-sm">Professional mental guidance</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-primary rounded-full"></div>
      ...
      <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30">
        ...
        <CardContent className="relative p-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-primary rounded-full"></div>
              <span className="text-sm">Verified mental professionals</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 bg-primary rounded-full"></div>
          ...
          <Link href="/appointments">
            <Button
              variant="outline"
              className="w-full mt-10 border-2 border-primary/20 hover:border-primary/40 hover:bg-primary/5 font-semibold py-5 text-lg rounded-xl transition-all duration-300"
            >
