...
const MentalHealthOverview = async () => {
  const { totalAppointment, completedAppointment } =
    await getUserAppointmentStats();
    ...
    <>
      <Card className="lg:col-span-2">
        <CardHeader>
          ...
          <CardDescription>
            Keep track of your Mental care journey
          </CardDescription>
        </CardHeader>
        <CardContent>
