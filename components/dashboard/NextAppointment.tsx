...
import NoAppointment from "./NoNextAppointment";
...
const NextAppointment = async () => {
  ...
  // filter for upcoming CONFIRM appointment only (today or future)
  ...
  if (!nextAppointment) return <NoNextAppointment />; // no appointment, return nothing
