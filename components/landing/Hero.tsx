          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                {/* Badge */}
                <div className="hidden md:inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-primary/10 to-primary/5 rounded-full border border-primary/20 backdrop-blur-sm">
