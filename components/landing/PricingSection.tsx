      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Book therapy sessions for free and upgrade for unlimited AI mental
            wellness consultations. Perfect for ongoing emotional care.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <p className="text-muted-foreground">
                    Essential therapy session booking
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-sm">Unlimited session booking</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircleIcon className="w-5 h-5 text-primary mt-0.5 shrink-0" />
            ...
            <div className="relative bg-linear-to-br from-card/95 to-card/70 backdrop-blur-xl rounded-3xl p-8 border-2 border-primary/30 hover:border-primary/50 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-primary/20 scale-105">
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <p className="text-muted-foreground">
                    AI consultations + session booking
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircleIcon className="w-5 h-5 text-primary mt-0.5 shrink-0" />
                    <span className="text-sm">AI mental wellness guidance</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircleIcon className="w-5 h-5 text-primary mt-0.5 shrink-0" />
